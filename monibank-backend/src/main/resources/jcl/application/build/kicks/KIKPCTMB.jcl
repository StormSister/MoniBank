//KIKPCTMB JOB (TEST),'BUILD MBANK PCT',
//             CLASS=A,
//             MSGCLASS=A,
//             MSGLEVEL=(1,1),
//             USER=${JOB_USER},
...
*
*        MONIBANK TRANSACTIONS
*
         KIKPCT TYPE=ENTRY,TRANSID=MBH1,PROGRAM=MBHELLO
         KIKPCT TYPE=ENTRY,TRANSID=MBSQ,PROGRAM=MBSEQRY
         KIKPCT TYPE=ENTRY,TRANSID=MBAC,PROGRAM=ADDCUST
         KIKPCT TYPE=ENTRY,TRANSID=MBGW,PROGRAM=MBGATE
*
         KIKPCT TYPE=FINAL
         END
/*
...
//SYSIN    DD DUMMY
//SYSLMOD  DD DSN=HERC01.KICKS.V1R5M0.SKIKLOAD(KIKPCTMB),DISP=SHR
//SYSUT1   DD UNIT=SYSDA,SPACE=(CYL,(2,1))
//SYSPRINT DD SYSOUT=*
