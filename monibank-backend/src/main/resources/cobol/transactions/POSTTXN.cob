      ...
      * GLOBAL VSAM ACCESS ORDER: SEQFILE BEFORE ACCTFILE.
      * THE SEQUENCE VALUE IS NOT ADVANCED UNTIL THE ACCOUNT IS VALID.
      ...
      * LOCK THE ACCOUNT AFTER SEQFILE, THEN VALIDATE THE POSTING.
