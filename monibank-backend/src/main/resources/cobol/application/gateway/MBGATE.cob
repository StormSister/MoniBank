      ...
      * ROUTING ONLY. INPUT LAYOUT BELONGS TO EACH PROGRAM.
           ...
           IF WS-OPERATION = 'POSTINT'
               MOVE 'POSTINT' TO WS-TARGET-PROGRAM.

           IF WS-OPERATION = 'DAYSTAT'
               MOVE 'DAYSTAT' TO WS-TARGET-PROGRAM.

           IF WS-OPERATION = 'GETSTAT'
               MOVE 'GETSTAT' TO WS-TARGET-PROGRAM.

           IF WS-TARGET-PROGRAM = SPACES
               MOVE 'ERROR' TO WS-STATE
               MOVE 'CUSTOMER ACCOUNT CARD TXN INTEREST REPORT OPS'
                   TO WS-MESSAGE
               GO TO SHOW-SCREEN.
      ...
      * LIST OPERATIONS RETURN COMPLETE DATA THROUGH MBRESULT.
       ...
       NEW-REQUEST.
           ...
           MOVE 'MONIBANK OPS READY. CLEAR=EXIT.'
               TO WS-MESSAGE.
           GO TO SHOW-SCREEN.
