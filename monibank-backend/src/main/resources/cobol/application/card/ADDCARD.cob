      ...
      * GLOBAL VSAM ACCESS ORDER STARTS WITH SEQFILE.
      * KEEP THIS ORDER CONSISTENT WITH ADDCUSG, ADDACCT AND POSTTXN.
      ...
      * VERIFY THE ACCOUNT ONLY AFTER SEQFILE HAS BEEN ACQUIRED.
      * ON FAILURE FINISH-PROGRAM RELEASES THE SEQUENCE LOCK.
